<html lang="en">
   <head>
      <title>kavyanshtravels.com | Invoice</title>
      <meta charset="utf-8">
	...
	<?php 
		...
		<header class=" ">
			<div class="container header_section">
				...
				<div class="header-bottom-bar">
				  <div><span class="phone"><a href="tel:<?php echo company_contact(); ?>"><i class="fa fa-phone"></i> &nbsp; <?php echo getAdminPhone(); ?></a></span></div>
				   <div><span><a href="mailto:info@trackitinerary.com"><i class="fas fa-envelope"></i> &nbsp; <?php echo admin_email(); ?></a></span></div>
				   <div><span><a href="http://www.trackitinerary.com" target="_blank"><i class="fas fa-globe"></i> &nbsp; <?php echo get_site_link(); ?></a></span></div>
				</div>
			</div>
      </header>
		<style type="text/css">
			...
			<div class="container">
				<div class="col-md-12 p-4">
				   <div class="Confirmation_voucher">
						<strong>
							<p style="display: inline-block; float: left;">Tax Invoice</p>
						</strong>
					  <!--p class="day_night"><?php //echo $iti->duration . " ( " . $iti->package_name . " )"; ?></p-->
					  <!--print btn-->
						<div class="clearfix text-center hideprint float-right">
         ...
         <div class="container">
            <div class="row">
			   ...
			   <div class="col-md-4 d-flex align-items-center justify-content-end ">
                  <div class="p-3 w-100 v-details">
                     <!--h4 class="text-center">Tax Invoice</h4-->
                     <p><strong>Booking ID:</strong></p>
                     <p><span class="float-right"><?php echo $inv->booking_id; ?></span></p>
                     <p><strong>Dated: </strong></p>
                     <p><span class="float-right"><?php echo $iti->t_end_date; ?></span></p>
                     <p><strong>Invoice No.:</strong></p>
                     <p><span  class="float-right"><?php echo $inv->invoice_no; ?></span></p>
                  </div>
               </div>
               ...
               <div class="table-responsive">
                  <!--  <h5 class="cost"><?php // echo ucwords($customer_name); ?></h5> -->
					<table class="table">
					   <tr>
						  ...
						  <th width="60%" class="">Particular</th>
						  <th width="15%" class="">HSN/SAC</th>
						  <th width="15%" class="text-right">Amount <small> (in Rs.)</small></th>
					   </tr>
					   <tr>
						  <td>1</td>
						  <td><?php echo $iti->duration; ?> ( <?php echo $iti->package_name; ?> )  </td>
						  <td><?php echo hsn_sac_number(); ?></td>
						  <td class="text-right "><?php echo number_format($p_cost_n,2); ?></td>
						</tr>
				...
				<table class="table">
					<tr>
						...
						<th class="">Gross Total</th>
						<th class=""></th>
						<th class="text-right"><?php echo number_format($p_cost_n,2); ?></th>
					</tr>  
    ...
    <hr>
            <div class="container">    
               ...
               <div class="terms">
                    ...
                    <hr>
                    <p class="text-right"><strong>for <?= !empty(get_site_title()) ? get_site_title() : ''; ?></strong></p>

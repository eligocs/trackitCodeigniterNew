<html lang="en">
   <head>
      <title>kavyanshtravels.com <?php echo isset( $receipts[0]->receipt_type ) ? ucfirst($receipts[0]->receipt_type) : ""; ?> Receipt</title>
      <meta charset="utf-8">
   ...
   <body>
      ...
      <div class="wrapper">
            ...
            <div class="container header_section">
               <div class="row">
                  ...
                  <div class="col-md-8 contact_details">
                     <address>
                        <!--<strong>Kavyansh Travels Pvt. Ltd.</strong><br>-->
                        <!--Demo Office<br>-->
                        <!--Demo City, <br>-->
                        <!--Demo State -171054-->
                          <?= getaddress() ?>
               ...
               <div class="header-bottom-bar">
                  <span class="phone"><a href="tel:<?php echo company_contact(); ?>"><i class="fas fa-phone"></i> &nbsp; <?php echo getAdminPhone(); ?></a></span>
                  <span><a href="mailto:info@trackitinerary.com"><i class="fas fa-envelope"></i> &nbsp; <?= admin_email() ?></a></span>
                  <span><a href="http://www.itinerary.com" target="_blank"><i class="fas fa-globe"></i> &nbsp;<?= get_site_link() ?></a></span>
               </div>
            </div>
         </header>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-8 from">
                     ...
                     <h5><?php echo ucwords($customer_name); ?></h5>
                  ...
                  <div class="col-md-4 d-flex align-items-center justify-content-end ">
                     <div class="p-3 w-100 v-details">
                        <h3 class=""><?php echo $receipt_type; ?> Receipt</h3>
                        <p><strong>Receipt No.</strong></p>
                        <p><span class=""><?php echo $receipt->voucher_number; ?> </span></p>
                        <p><strong>Receipt Date</strong></p>
                        <p><span class=""><?php echo date("d/m/Y", strtotime( $receipt->voucher_date )); ?></span></p>
               ...
               <div class="table-responsive">
                  <table class="table">
                     ...
                     <tr>
                        ...
                        <td class="text-right"><?php echo isset( $receipt->amount_received ) ? $receipt->amount_received : ""; ?></td>
                        <td>
                           <!--Credit -->
                        </td>
                     </tr>
         ...
         <div class="container second_countainer">
            <!-- Total Cost -->
            <div class="table-responsive">
            <?php 
            if(!empty($iti_payment[0]->booking_id)) {
            ?>
               <table class="table">
                  <tr class="cost">
                  ...
                  <tr>
                     <td colspan="3"></td>
                     <td class="text-right "><?php echo number_format( $receipt->amount_received ); ?></td>
                  </tr>
               </table>
            <?php } ?>
            ...
            <hr>
            <p class="text-right "><strong>for Kavyansh Travels PVT. LTD.</strong></p>
            <!--terms-->

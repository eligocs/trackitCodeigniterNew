    ...
    <div class="page-content-wrapper">
		...
		?>
            ...
            <div class="portlet-body bg-white p-3 rounded-4 shadow-sm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 my-2">
                            <div class="form-group">
                                <label class="control-label" data-toggle="tooltip" data-placement="top"
                                    title="Note: If you not find customer in list create new account in customer account section.">Select
                                    Customer Account*
                        ...
                        <div class="col-md-4 my-2">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Voucher Date" name="voucher_date"
                                    class="form-control datepicker" value="" required="required" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 my-2">
                            <div class="form-group">
                                ...
                                <input type="text" data-toggle="tooltip"
                                    title="Online transfer,TRANSFER CHEQUE,CASH ETC."
                                    placeholder="eg: Online transfer,TRANSFER CHEQUE,CASH" name="transfer_type"
                        ...
                        <div class="col-md-4 my-2">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Transfer Reference" name="transfer_ref"
                        ...
                        <div class="col-md-4 my-2">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Transfer Date" name="transfer_date"
                                    class="form-control datepicker" value="" required="required" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 my-2">
                            <div class="form-group">
                                ...
                                <input type="number" placeholder="Amount Received" name="amount_received"
                                    class="form-control" value="" required="required" />
                            </div>
                        </div>
                ...
                <?php }else{ ?>
                <div class="alert alert-info">You need to create customer account before generate invoice. Click below
                    link to create customer account. </div>
                <hr>
                <div class="text-center">
                    <a class="btn btn-success" href="<?php echo site_url("accounts/add_cus_account"); ?>"
                        title="Add New Account">Add account</a>
                </div>
                <?php } ?>
                ...
                success: function(res) {
                    if (res.status == true) {
                        ...
                        window.location.href =
                            "<?php echo site_url("accounts/view_receipt/");?>" + res
                            .id;
                    } else {
                        resp.html(

        ...
        <div class="page-content">
            ...
            <div class="portlet box blue mb0">
                <div class="portlet-title">
                    ...
                    <!-- View Itineray Button -->
                    <a class="btn btn-outline-success float-end me-2" target="_blank" href="<?php echo iti_view_single_link($hotel_book->iti_id); ?>" title="View Itinerary">
                    <i class="fa-solid fa-eye"></i> View Itinerary</a>
                </div>
            </div>
            <!-- SHOW HOTEL STATUS -->
            <div class="bg-white p-3 rounded-4 shadow-sm mb-4">
                <div class="row">
                    ...
                    <div class="col-md-6 my-2">
                        ...
                        <?php if( $role == 99 || $role == 98 || $role == 97  ){ ?>
                        <div class="mt-4">
                            <a href="<?php echo base_url("hotelbooking/duplicate_hotel_booking/{$hotel_book->id}");?>" id="clone_hotel_booking" class="btn btn-success" title="click to clone Booking"><i class='fa fa-files-o' aria-hidden='true'></i> Duplicate Booking</a> 
                            <!--clone booking btn-->
                        </div>
                        <?php } ?>
                    </div>
                    ...
                    <div class="col-md-6 my-2">
                        <div class="form-group">
                            ...
                            <blockquote>
                                <div class="form-control" placeholder="Disabled" disabled="">
                                    <?php echo $hotel_book->booking_cancel_note; ?>
                                </div>
                            </blockquote>
                        </div>
                        ...
                        <div class="col-md-12 my-2">
                            ...
                            <div class="mt-3">
                                ...
                                if( $hotel_book->email_count > 0 ){
                                    echo "<a title='Click to Approve Hotel Booking' href=" . site_url("confirm/hotelbooking?hotel_id=". base64_url_encode($hotel_book->hotel_id) . "&iti_id=" . base64_url_encode($hotel_book->iti_id) . "&token_key=" . base64_url_encode($hotel_book->id) ) . "&status=" . base64_url_encode(9) . " target='_blank' class='btn btn-success' >
                                    <i class='fa fa fa-check' aria-hidden='true'></i> Confirm Booking</a>";
                                }	
                                ?>
                            </div>
                            <?php } ?>
            ...
            <div class="portlet box blue mt-5">
                <div class="portlet-title">
                    <div class="caption">Room Details 
                        <strong>Invoice Id : <?php echo $hotel_book->invoice_id; ?></strong>
                    </div>
                </div>
            </div>
            ...
            <div class="portlet-body">
                <div class="bg-white p-3 rounded-4 shadow-sm">
                    <div class="form-group ">
                        ...
                        <div class="mail-info d-flex justify-content-between mb-3">
                            <?php 
                            if( $role == 99 || $role == 98 || $role == 97  ){
                                ...
                                if( $hotel_book->booking_status != 8 && $hotel_book->booking_status != 7 ){ 
                                    ...
                                    echo '<a id="hotel_email_sent" href="#" class="btn btn-primary"><i class="fa-solid fa-paper-plane"></i> Send</a>';
                                }
                                
                                if( $hotelbooking_sent == 0  && ( $hotel_book->booking_status != 8 || $hotel_book->booking_status != 7 ) ){ 
                                    echo "<div class='badge bg-primary p-2'>Hotel booking email not send yet.</div>";
                                }else{ 
                                    echo "<div><span class='badge bg-success fw-normal p-2'><i class='fa-solid fa-check'></i> Hotel booking Sent " . $hotelbooking_sent . " Times.</span></div>";
                                }
                            }
                            ?>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-condensed table-hover table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-mdd-10 form_vr">
                                        <?php echo get_customer_name($hotel_book->customer_id); ?>
                                    </div>
                                </td>
                                <?php
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-mdd-10 form_vr">
                                        <?php echo display_month_name($hotel_book->check_out); ?>
                                    </div>
                                </td>
                    ...
                    <div class="text-center">
                        <a  href="<?php echo site_url("hotelbooking/edit/{$hotel_book->id}/{$hotel_book->iti_id}"); ?>" class='btn btn-outline-secondary' title="Update Hotel Booking Info">
                        <i class='fa-solid fa-pen-to-square'></i> Update Booking</a>
                    </div>
                    <?php } ?>
                </div>
            </div>

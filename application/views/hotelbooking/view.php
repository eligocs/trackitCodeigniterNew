        ...
        <div class="page-content">
            ...
            <div class="portlet box blue mb0">
                <div class="portlet-title">
                    ...
                    <a class="btn btn-outline-primary float-end" href="<?php echo site_url("hotelbooking"); ?>" title="Back">
                        <i class="fa-solid fa-reply"></i> Back
                    </a>
                    <a class="btn btn-outline-secondary float-end me-2" target="_blank"  href="<?php echo iti_view_single_link($hotel_book->iti_id); ?>" title="View Itinerary">
            ...
            <div class="portlet-body">
                <div class="bg-white p-3 rounded-4 shadow-sm mb-4">
                    <div class="form-group ">
                        ...
                        <div class="align-items-center d-flex justify-content-between mail-info mb-3">
                            <?php 
                            if( $role == 99 || $role == 98 || $role == 97  ){
                                //show sent button if booking not canceled or declined
                                //if(  $hotel_book->is_approved_by_gm == 0 ){
                                    //echo '<a id="hotel_quotation_sent" href="#" data-id="' . $hotel_book->id . '" class="btn green uppercase ">Send Quotation To GM</a>';
                                ...
                                if( $hotel_book->booking_status != 8 && $hotel_book->booking_status != 7 ){ 
                                    ...
                                    echo '<a id="hotel_email_sent" href="#" class="btn green uppercase ">Send</a>';
                                }
                    ...
                    <div class="text-center">
                        <a href="<?php echo site_url("hotelbooking/edit/{$hotel_book->id}/{$hotel_book->iti_id}"); ?>" class='btn btn-outline-secondary' title="Update Hotel Booking Info"><i class='fa-solid fa-pen-to-square'></i> Update Booking</a>
                    </div>

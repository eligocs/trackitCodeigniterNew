...
<head>
   ...
   <!-- <link href="<?php // echo base_url();
                     ?>site/assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" /> -->
   ...
   <!--link href="<?php //echo base_url();
                  ?>site/assets/css/jquery.multiselect.css" rel="stylesheet" type="text/css" /-->
   ...
   ?>
   <!-- <link href="<?php echo base_url(); ?>site/assets/css/<?php echo $theme_css ?>.css" data-style_colour = "<?php //echo $theme_css 
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white <?php echo $theme_css; ?>">
   ...
   <div class="page-wrapper">
      ...
      <div class="page-header navbar navbar-fixed-top">
         ...
         <strong class="red"> <?php //echo get_last_login() 
                              ?></strong>
         <!--clock section

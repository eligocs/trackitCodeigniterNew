						...
						<div id="res"></div>
							<?php if( isset( $pending_vouchers ) && !empty( $pending_vouchers ) ){ 
								...
								foreach( $pending_vouchers as $voucher ){
									...
									$btn_view = "<a target='_blank' title='View' href=" . site_url("itineraries/view/{$voucher->iti_id}/{$voucher->temp_key}") . " class='btn_eye' ><i class='fa-solid fa-eye' aria-hidden='true'></i></a>";
									echo "<tr>
										<td>{$counter}</td>

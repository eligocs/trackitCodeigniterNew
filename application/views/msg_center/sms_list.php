      ...
      <div class="page-content">
         ...
         <div class="portlet box blue">
            <div class="portlet-title">
               <div class="caption">
               <i class="fa-solid fa-comment-sms"></i> Message Log Listing
               </div>
               <a class="btn btn-primary float-end" href="<?php echo site_url("msg_center/send_new_message"); ?>" title="Send Message"><i class="fa-solid fa-plus"></i> Create Message</a>
            </div>
         </div>

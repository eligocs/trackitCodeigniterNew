                    ...
                    <div class="portlet-body ">
                        <div class="customer-details">
                            <div class="colum_table">
                                ...
                                <div class="col-md-12 col-lg-6">
                                    <div class="col-md-8 form_vl"><strong>Customer Name:</strong></div>
                                    <div id='cus_name' class="col-md-4 form_vr"><?php echo $pay->customer_name; ?></div>
                                </div>
                                <div class="col-md-12 col-lg-6">
                                    <div class="col-md-8 form_vl"><strong>Customer Contact:</strong></div>
                                    <div class="col-md-4 form_vr"><?php echo $pay->customer_contact; ?></div>
                                </div>
                                <div class="col-md-12 col-lg-6">
                                    <div class="col-md-8 form_vl"><strong>Customer Email:</strong></div>
                                    <div class="col-md-4 form_vr red"><?php echo $pay->customer_email; ?></div>
                                </div>
                                <div class="col-md-12 col-lg-6">
                                ...
                                <div class="col-md-12 col-lg-6">
                                    <div class="col-md-8 form_vl"><strong>Next Installment Amount:</strong></div>
                                    <div class="col-md-4 form_vr"><?php echo $pay->next_payment; ?></div>
                                </div>
                                <div class="col-md-12 col-lg-6">
                                    <div class="col-md-8 form_vl"><strong>Next Installment Date:</strong></div>
                                    <div class="col-md-4 form_vr">
                                        <?php echo display_month_name( $pay->next_payment_due_date ); ?></div>
                                </div>
                                <div class="col-md-12 col-lg-6">
                                    <div class="col-md-8 form_vl"><strong>Balance Pending:</strong></div>
                                    <div class="col-md-4 form_vr">
                                        <?php echo number_format( $pay->total_balance_amount ) . " /-"; ?></div>
                                </div>
                                <div class="col-md-12 col-lg-6">
                                    <div class="col-md-8 form_vl"><strong class='red'>Travel Date</strong></div>
                                    <div class="col-md-4 form_vr"><strong
                    ...
                    <div class="portlet-body">
                        <div class="customer-details">
                            <div class="colum_table ">
                                ...
                                <div class="col-md-12 col-lg-6">
                                    <div class="col-md-8 form_vl"><strong>Advance Received: </strong></div>
                                    <div class="col-md-4 form_vr">
                                        <?php echo number_format($pay->advance_recieved) . " /-"; ?></div>
                                </div>
                                <div class="col-md-12 col-lg-6">
                                ...
                                <div class="col-md-12 col-lg-6">
                                    <div class="col-md-8 form_vl"><strong>Third Installment Amount:
                                            (<?php echo $pd; ?>)</strong></div>
                                    <div class="col-md-4 form_vr">
                                        <?php echo number_format($pay->third_payment_bal) . " /-"; ?></div>
                                </div>
                                <div class="col-md-12 col-lg-6">
                                    <div class="col-md-8 form_vl"><strong>Third Installment Date:</strong></div>
                                    <div class="col-md-4 form_vr">
                                ...
                                <div class="col-md-12 col-lg-6">
                                    <div class="col-md-8 form_vl"><strong>Final Installment Amount:
                                            (<?php echo $pd; ?>)</strong></div>
                                    <div class="col-md-4 form_vr">
                                        <?php echo number_format($pay->final_payment_bal) . " /-"; ?></div>
                                </div>
                                <div class="col-md-12 col-lg-6">
                                    <div class="col-md-8 form_vl"><strong>Final Installment Date: </strong></div>
                                    <div class="col-md-4 form_vr">
                                ...
                                <div class="col-md-12 col-lg-6">
                                    <div class="col-md-8 form_vl"><strong class='red'>Total Discount:</strong></div>
                                    <div class="col-md-4 form_vr">
                                        <?php echo number_format($pay->total_discount) . " /-"; ?></div>
                                </div>
                                <div class="col-md-12 col-lg-6">
                                    <div class="col-md-8 form_vl"><strong></strong></div>
                                    <div class="col-md-4 form_vr"></div>
                                </div>
                                <?php } ?>
                                ...
                                <div class="col-md-12 col-lg-6">
                                    <div class="col-md-8 form_vl"><strong>Approval Note:</strong></div>
                                    <div class="col-md-4 form_vr"><?php echo $pay->approved_note; ?></div>
                                </div>

                                <?php if( $refund_transaction ){ ?>
                                <div class="col-md-12 col-lg-6">
                                    <div class="col-md-8 form_vl"><strong class='red'>Refund Amount:</strong></div>
                                    <div class="col-md-4 form_vr"><strong

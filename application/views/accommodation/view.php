		...
		?>
            <?php if( !empty($itinerary[0] ) ){
				...
				if( $iti->is_amendment == 2 ){ 
					...
					$amendment_note = !empty( $amendment_cmt ) ? "<p class='red text-center'>Amendment: {$amendment_cmt[0]->review_comment}</p>" : "";
				} 
            ...
            <div class="portlet box blue margin-top-50" id="update_iti_hold_status">
                ...
                <form id="frm_update_booking_status_agent">
                        ...
                        <div class="booking_section" style="display:block;">
                            ...
                            <div id="due_payment_section">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" required id="next_pay_balance" data-date-format="yyyy-mm-dd"
                                        name="next_payment_bal" placeholder="Second Payment Balance"
                                        class="form-control" value="<?php echo $second_payment_bal; ?>">
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" required readonly id="balance_pay" name="total_balance"
                                    placeholder="" class="form-control" value="<?php echo $total_balance_amount; ?>">
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <img id="client_aadhar_card_priview"
                                    src="<?php echo $doc_path . $pay_detail->client_aadhar_card; ?>"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <img id="payment_screenshot_priview"
                                    src="<?php echo $doc_path . $pay_detail->payment_screenshot; ?>"
                                    style="display: block;" width="100" height="100" />
                            </div>
                        </div>
                        <!--booking section-->
                    ...
                    <div class='form-group col-md-3'>
                        <div class="button_sec" style="margin-top: 30px;">
                            <button name="action" class="btn green button-submit" type="submit">UPDATE PAYMENT
                                DETAILS</button>
                        </div>
                    </div>
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <h3 class="custom_title">Rejected Itinerary</h3>
                </div>
                <div class="portlet-body">
                    ...
                    <form id="submitRates">
                        ...
                        <div class='form-group col-md-8'>
                            <div class="button_sec" style="margin-top: 30px;">
                                ...
                                <?php }else{ ?>
                                <button name="action" class="btn green button-submit" type="submit"
                                    value="supermanager">Send To
            ...
            <div class="row" id="update_rates_section">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead class="thead-default">
                            <tr>
                                <p class="text-center"><strong style="color: red; font-size: 22px;">Old Price</strong>
                                </p>
                            </tr>
                            <tr>
                                <th> 2 Star</th>
                ...
                <form id="frmDiscountRates">
                    ...
                    <div class='form-group col-md-12'>
                        <p class="text-center"><strong style="font-size: 22px; color: green;">Please Update Rates By
                                Hotel
                    ...
                    <div class='update_margin_discount' style="display: none;">
                        <div class='standard  form-group col-md-6'>
                            <label for="inp_inc_price">Set Margin In Base Price (%): <span class="red"
                                    style="font-size: 12px;"> Last Margin:
                                    <?php echo $last_agent_margin; ?>%</span></label>
                    ...
                    <div class='update_price_customprice' style="display: none;">
                        <div class='standard  form-group col-md-2'>
                            ...
                            <input <?php echo $st_req; ?> name="standard_rates" type="number"
                                class='form-control'></input>
                        </div>
                        <div class='deluxe form-group col-md-2'>
                        ...
                        <div class="col-md-12 perperson_section" style="display: none;">
                            ...
                            <div class='super_deluxe form-group col-md-3'>
                                ...
                                <input <?php echo $sd_req; ?> name="per_person_ratemeta[super_deluxe_rates]"
                                    type="number" class='form-control' placeholder="Luxury Per/Person Cost"></input>
                            </div>
                            <div class='luxury form-group col-md-3'>
                            ...
                            <div class='standard  form-group col-md-3'>
                                <label><strong class="red">Deluxe (Per/child):</strong><span
                                        style="font-size:10px; color: red;"> ( Leave empty if not exists)</span></label>
                                <input <?php echo $st_req; ?> name="per_person_ratemeta[child_standard_rates]"
                                    type="number" class='form-control' placeholder="Deluxe Per/child Cost"></input>
                            </div>

                            <div class='deluxe form-group col-md-3'>
                                <label><strong class="red">Super Deluxe (Per/child):</strong><span
                                        style="font-size:10px; color: red;"> ( Leave empty if not exists)</span></label>
                                <input <?php echo $d_req; ?> name="per_person_ratemeta[child_deluxe_rates]"
                            ...
                            <div class='luxury form-group col-md-3'>
                                <label><strong class="red">Super Luxury (Per/child):</strong><span
                                        style="font-size:10px; color: red;"> ( Leave empty if not exists)</span></label>
                                <input <?php echo $l_req; ?> name="per_person_ratemeta[child_luxury_rates]"
                                    type="number" class='form-control'
                                    placeholder="Super Deluxe Per/child Cost"></input>
                            </div>
            ...
            <form id="frmDiscountSupermanager">
                ...
                <div class='standard  form-group col-md-2'>
                    ...
                    <input name="standard_rates" type="number"
                        ...
                        class='form-control' value="<?php if( !empty( $stand_r ) ){ echo $stand_r; } ?>"></input>
                </div>
                <div class='deluxe form-group col-md-2'>
                    <label><strong>Super Deluxe:</strong></label>
                    <input <?php if( empty( $del_r ) ){ echo "readonly"; }else{ echo "required"; } ?>
                        name="deluxe_rates" type="number" class='form-control'
                        value="<?php if( !empty( $del_r ) ){ echo $del_r; } ?>"></input>
                </div>
                <div class='super_deluxe form-group col-md-2'>
                    <label><strong>Luxury:</strong></label>
                ...
                <div class='luxury form-group col-md-2'>
                    ...
                    <input <?php if( empty( $lux_r ) ){ echo "readonly"; }else{ echo "required"; } ?>
                        name="luxury_rates" type="number" class='form-control'
                        value="<?php if( !empty( $lux_r ) ){ echo $lux_r; } ?>"></input>
                </div>
                <!--div class='form-group col-md-2' >
							<label><strong>GST Inc.:</strong></label>
							<input type="checkbox" value="<?php //echo $inc_gst; ?>" class='form-control' <?php //echo !empty($inc_gst) ? "checked='checked'" : "" ; ?> id="incgst"></input>
                ...
                <div class="col-md-12 perperson_section"
                    ...
                    <div class='deluxe form-group col-md-3'>
                        ...
                        <input name="per_person_ratemeta[deluxe_rates]" value="<?php echo $d_pp; ?>" type="number"
                            <?php if( empty( $del_r ) ){ echo "readonly"; }else{ echo "required"; } ?>
                            class='form-control' placeholder="Super Deluxe Per/Person Cost"></input>
                    </div>
                    <div class='super_deluxe form-group col-md-3'>
                        <label><strong>Luxury (Per/Person):</strong></label>
                        <input name="per_person_ratemeta[super_deluxe_rates]" value="<?php echo $sd_pp; ?>"
                            type="number" <?php if( empty( $sdelux_r ) ){ echo "readonly"; }else{ echo "required"; } ?>
                            class='form-control' placeholder="Luxury Per/Person Cost"></input>
                    </div>
                    <div class='luxury form-group col-md-3'>
                        <label><strong>Super Luxury (Per/Person):</strong></label>
                        <input name="per_person_ratemeta[luxury_rates]" type="number"
                            <?php if( empty( $lux_r ) ){ echo "readonly"; }else{ echo "required"; } ?>
            ...
            <div class="row2">
                ...
                <div class="portlet box blue margin-top-40">
                    ...
                    <div class="portlet-body">
                        <div class="table-responsive booking_details_pro">
                            <table class="table table-bordered">
                                <thead class="thead-default">
                                    <tr>
                                        <th>Sr.</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2"><strong><?php echo number_format($profit) . "</strong>" . $pro_text; ?>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <p class="text-center"><strong class="alert alert-info">Waiting for price update from manager..</strong>
                </p>
        ...
        jQuery(document).ready(function($) {
                    ...
                    swal({
                        ...
                        if (willDelete) {
                            $.ajax({
                                ...
                                error: function(err) {
                                    swal("Error!", "Something went wrong2!",
                                        "danger");
                                }
                            });
                        }
            ...
            $(document).on("blur", "#next_pay_balance", function() {
                ...
                var addAttr = _this_val < pending ? $("#third_payment_bal, #third_payment_date").attr(
                        "required", "required") : $("#third_payment_bal, #third_payment_date")
                    .removeAttr(
                        "required");
            });
            ...
            $(document).on("blur", "#third_payment_bal", function() {
                ...
                //if advance is greater than final amount
                if (_this_val > pending) {
                    swal("Warning!", "Payment should be less than Pending amount = " + pending,
                        "warning");
                    $(".resPonse").html(

            ...
            <div class="portlet box blue mb0">
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-users"></i>
                        <strong>Customer Id: </strong><span class=""> <?php echo $iti->customer_id; ?></span> &nbsp;
                        &nbsp;
                        <?php if( is_admin_or_manager() ){ ?>
                        <strong>Customer Type: </strong><span class=""><?php echo $cus_type; ?>&nbsp; &nbsp;
                ...
                <div class="row step-background-thin ">
                    ...
                    <div class="col-md-4 bg-grey-steel mt-step-col active">
                        ...
                        <div class="mt-step-title uppercase font-grey-cascade">
                            <strong><?php echo $iti->approved_package_category; ?></strong></div>
            ...
            <div class="mt-element-step">
                <div class="row step-background-thin ">
                    ...
                    <div class="col-md-4 bg-grey-steel mt-step-col error">
                        <div class="mt-step-number">2</div>
                        <div class="mt-step-title uppercase font-grey-cascade">
                            <strong><?php echo $paymentDetails[0]->total_balance_amount; ?>/-</strong></div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a title='View'
                                                        ...
                                                        class='btn btn_eye'><i class='fa-solid fa-eye'
                                    ...
                                    <table class="table table-bordered ">
                                        <tbody>
                                            ...
                                            <tr class="">
                                                ...
                                                <td width="33%">
                                                    <strong><?php echo $iti->approved_package_category; ?></strong></td>
                                                <td width="33%">

		...
		<div class="page-content">
			<?php if( !empty($itinerary[0] ) ){
				...
				<div class="row2">
					<div class="portlet box blue">
						<div class="portlet-title">
							<h3 class="custom_title">View Amendment</h3>
						</div>
						<div class="portlet-body">
							<div class="well well-sm text-center d-flex justify_content_between">
					...
					if( !empty($benefits_m) ){
						echo '<div class="portlet box blue margin-top-50"><div class="portlet-title"><h3 class="custom_title">Benefits of Booking With Us</h3></div>';
						echo "<div class='portlet-body'><ul class='inclusion'>";
						if( $count_bn_inc > 0 ){
					...
					<?php }else if( $iti->sent_for_review == 1 ){
						...
						<p class="text-center  success_pill d_inline_block margin-top-20"> New Price Updated By Admin/Manager!</p>
						
						
						<div id="update_payment_details" style="line-height: 30px;">
						...
						<?php } ?>
					<?php }else{
						echo '<p class="text-center success_pill d_inline_block"> New Price Updated!</p>';
					} ?>	
				</div>
			</div>

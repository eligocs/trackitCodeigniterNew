						...
						<div class="form-horizontal" id="itiForm_form">
							...
							<section>
								...
								<div class="table-responsive">
									<table class="table table-sm table-bordered table_details">
										<tr class="text-nowrap">
											<th>Customer Name</th>
											<td><?php if(isset($cust->customer_name)){ echo $cust->customer_name; }?></td>
											<th>Contact</th>
											<td>
												<?php if(isset($cust->customer_contact)){ echo $cust->customer_contact; }?>
											</td>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="tab1">
											...
											<div class="row">
												...
												<div  class="col-md-6 my-2">
													<div class="form-group">
														<label class="control-label">Room Category
															<sup class="text-danger">*</sup>
														</label>
														<div class="row">
												...
												<div  class="col-md-6 my-2">
													<div class="form-group">
														<label class="control-label">Extra bed/Without extra bed</label>
														<div class="row">
															<div class="col-md-6 mb-3 mb-md-0">
										...
										<div class="tab-pane" id="tab2">
											...
											<div class="mt-repeater">
												<div data-repeater-list="tour_meta" class="day-wise-tour">
																...
																<div class="row">
																	...
																	<div class="col-md-2 my-2">
																		...
																		<div class="mt-repeater-input">
																			<label class="control-label">Tour Date
																				<sup class="text-danger">*</sup>
																			</label>
																	...
																	<div class="col-md-6 my-2">
																		<div class="mt-repeater-input  t_title">
																			<label class="control-label">Tour Title
																				<sup class="text-danger">*</sup>
																			</label>
																	...
																	<div class="col-md-12 my-2">
																		<div class="mt-repeater-input mt-repeater-textarea t_des">
																			<label class="control-label">Tour Description
																				<sup class="text-danger">*</sup>
																			</label>
																	...
																	<div class="col-md-4 my-2">
																		<div class="mt-repeater-input  ">
																			<label class="control-label">Meal Plan
																				<sup class="text-danger">*</sup>
																			</label>
													...
													<div data-repeater-item class="mt-repeater-item daywise_section">
														...
														<div class="row">
															...
															<div class="col-md-4 my-2">
																<div class="mt-repeater-input form-group">
																	<label class="control-label">Attractions</label>
																	<div class="hot_des">
																		<input type="hidden" value="" class="tags_values" name="hot_des"> <input type="text" value="" placeholder="Add a Hot destination" />
																	</div>
																</div>
															</div>
												...
												<a href="javascript:;" data-repeater-create class="btn btn-primary mt-repeater-add addrep mt-3"> <i class="fa-solid fa-plus"></i></a>
											</div>
										</div>
										<!-- End Day Wise Itinerary -->
										
										<!-- Begin Inclusions and Exlusions -->
														...
														<div class="repeater_wrapper" data-repeater-list="inc_meta">
															...
															<div data-repeater-item class="mt-repeater-inc-item form-group">
																<div class="mt-repeater-inc-cell row mb-3">
																	<div class="mt-repeater-inc-input col-md-12 position-relative">
													...
													<div class="mt-repeater-spinc tour_field_repeater_sp">
														...
														<div class="repeater_wrapper" data-repeater-list="booking_benefits_meta">
															<?php 
																...
																$count_benefit_inc = !empty($benefits_inc)  ? count( $benefits_inc ) : '';
											...
											<div class="mt-repeater-hotel tour_field_repeater">
												...
												<?php $hotel_meta = unserialize($iti->hotel_meta); 
															...
															<div data-repeater-item class="mt-repeater-hotel-item mb-4">
																...
																<div class="row">
																	<div class='mt-repeater-hotel-input form-group col-xxl-3 col-xl-4 col-md-4 col-sm-6 mb-3' >
																		<label class="control-label"><strong>Hotel Location:</strong></label>
													...
													<?php }else{ ?>	
														<div data-repeater-item class="mt-repeater-hotel-item mb-4">
															<div class="row">
																<div class='mt-repeater-hotel-input col-xxl-3 col-xl-4 col-md-4 col-sm-6 mb-3' >
																	<label class="control-label"><strong>Hotel Location:</strong></label>
																	<input required type="text" name='hotel_location' class='form-control' placeholder="Eg. Shimla/Manali">
																</div>
																<div class='mt-repeater-hotel-input standard col-xxl-2 col-xl-4 col-md-4 col-sm-6 mb-3' >
																	<label class="control-label"><strong><?= totalHotelCategory()[0]->hotel_category_name ?>:</strong></label>
																	<textarea name="hotel_standard" required class='form-control'></textarea>
																</div>
																
																<div class='mt-repeater-hotel-input deluxe col-xxl-2 col-xl-4 col-md-4 col-sm-6 mb-3' >
																	<label class="control-label"><strong><?= totalHotelCategory()[1]->hotel_category_name ?>:</strong></label>
																	<textarea name="hotel_deluxe" required class='form-control'></textarea>
																</div>
																<div class='mt-repeater-hotel-input super_deluxe col-xxl-2 col-xl-4 col-md-4 col-sm-6 mb-3' >
																	<label class="control-label"><strong><?= totalHotelCategory()[2]->hotel_category_name ?>:</strong></label>
																	<textarea name="hotel_super_deluxe" required class='form-control'></textarea>
																</div>
																<div class='mt-repeater-hotel-input luxury col-xxl-2 col-xl-4 col-md-4 col-sm-6 mb-3' >
																	<label class="control-label"><strong><?= totalHotelCategory()[3]->hotel_category_name ?>:</strong></label>
													...
													<div class="row mt-4">
														<div class="col-md-12">
														   <p class="text-center mb-0 fs-5">
															   <strong>Update New Price</strong>
															</p>
														</div>
														<div class="col-md-4">
															<div class="form-group">
																<label for="" class="control-label">
																	<strong>Old Price( with 
																		<?php echo $agent_margin; ?>% agent margin ): 
																	</strong>
																</label> 
																<?php echo $iti->old_package_cost; ?>
													...
													if( !empty($hotel_note_meta) ){
														for ( $i = 0; $i < $count_hotel_meta; $i++ ) { ?>
															<div data-repeater-item class="mt-repeater-hotel-note-item form-group">
																<!-- jQuery Repeater Container -->
																<div class="row mb-3">
																	<div class="mt-repeater-hotel-note-input col-md-12 position-relative">
			...
			jQuery('.mt-repeater').each(function(){
				...
				$(this).repeater({
					show: function () {
						...
						resultData.append("<div class='day_wise_preview' id=day_" + c_day  + "><strong class='day_pr'> Day: <span class='dd'>" + tour_day + "</span> </strong><h2>" + tour_name + "</h2>Tour Description: " + tour_des + "</div>Tour Date: " + tour_date + "</div>Meal Plan: " + meal_plan + "</div>Tour Distant: " + tour_distant + " Kilometer </div>" );

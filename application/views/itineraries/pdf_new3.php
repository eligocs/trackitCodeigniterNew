                ...
                <div style="line-height: 22px; position: absolute; width: 100%; box-sizing: border-box;">
                    ...
                    <div class="agent_details"
                        ...
                        <p style="margin: 0;color">Mob. <a href="tel:+91<?= $agent->mobile ?>"
                                style="color: #1715ec; text-decoration: none; margin-left: 8px;">+91 <?= $agent->mobile ?></a>
                        </p>
                        ...
                        <div style="margin-top: 14px; ">
                            ...
                            <?php
                                                foreach ($htd as $key =>$t) {
                                                    $hot_dest = trim($t);
                                                ?>
                            <span style="display: inline-block;font-size: 14px; font-weight: 500;  margin-left: 8px; line-height:1px; margin-top:-4px !important; "><?= ucfirst($hot_dest) ?> </span>
                            <?php
                                                } ?>
                        </div>
                        <?php
                    ...
                    <table style="border-collapse: collapse; width: 100%; font-size: 15px; box-sizing: border-box;">
                        ...
                        <tbody>
                            <?php
                                    ...
                                    ?>
                            <tr>
                                <td style="padding: 5px; border: 1px solid #c6c1c1; text-align: left;"><?= $city_name ?>
                                </td>
                            ...
                            <?php
                                    ...
                                    ?>
                            <tr>
                                <td style="padding: 5px; border: 1px solid #c6c1c1; text-align: left;">Discount Price</td>
                ...
                <div style="padding: 0 16px; margin: 20px 0;">
                    ...
                    <table
                        ...
                        <tr>
                            ...
                            <th style="padding: 5px; font-weight: 500; border: 1px solid #c6c1c1; text-align: left;">
                                Bank Name</th>
                            <td style="padding: 5px; border: 1px solid #c6c1c1; text-align: left;"><?= $b_name ?></td>
                        </tr>
                        <tr>
                            <th style="padding: 5px; font-weight: 500; border: 1px solid #c6c1c1; text-align: left;">
                                Payee Name</th>
                            <td style="padding: 5px; border: 1px solid #c6c1c1; text-align: left;"><?= $payee_name ?>
                            </td>
                        </tr>
                        <tr>
                            <th style="padding: 5px; font-weight: 500; border: 1px solid #c6c1c1; text-align: left;">
                                Account Type</th>
                            <td style="padding: 5px; border: 1px solid #c6c1c1; text-align: left;"><?= $ac_type ?></td>
                        </tr>
                        <tr>
                            <th style="padding: 5px; font-weight: 500; border: 1px solid #c6c1c1; text-align: left;">
                                Account Number</th>
            ...
            <fieldset style="border: 2px solid #ff0000; border-radius: 6px;">
                ...
                <div class="signature" style="margin-top: 30px; line-height: 26px; padding: 0 16px;">
                    ...
                    <p style="font-size: 16px; margin: 0;"><strong
                            style="font-weight: 500;"><?= $agent->first_name . " " . $agent->last_name ?></strong></p>
                ...
                <div class="address" style="padding: 0 16px; line-height: 26px; margin-top: 60px;">
                    ...
                    <p style="font-size: 14px; margin: 0;"><?= !empty(get_site_title()) ? get_site_title() : ''; ?>,</p>

...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/fonts/fontawesome-webfont.ttf?v=4.7.0">
        <title>PDF</title>
        ...
        <div style="max-width: 8.11in; width: 100%; margin: 0 auto; padding: 0.04in; ">
            <div class="page_content">
                <div style="position: relative;">
                    <div style="display: inline-block; padding: 10px 0 0 14px; position: absolute; z-index: 99;right: 30px;bottom: 33%;">
                    ...
                    <div style="line-height: 22px; position: absolute; width: 100%; box-sizing: border-box;">
                        ...
                        if ($user_info) {
                            $agent = $user_info[0];
                        ?>
                            <div class="agent_details" style="background: #fff; padding: 6px 20px; color:#000; line-height: 24px; float: right; border-bottom-left-radius: 16px; font-weight: 500;">
                                <p style="margin: 0;"><?= $agent->first_name . " " . $agent->last_name ?></p>
                                <p style="margin: 0;color">Mob. <a href="tel:+91<?= $agent->mobile ?>" style="color: #1715ec; text-decoration: none; margin-left: 8px;">+91
                                        <?= $agent->mobile ?></a>
                                </p>
                                <p style="margin: 0;">Email <a href="mailto:<?= $agent->email ?>" style="color: #1715ec; text-decoration: none; margin-left: 8px;"><?= $agent->email ?></a>
                                </p>
                            </div>
                        <?php
                            // dump($iti);die;
                    ...
                    ?>
                    <img style="max-width: 8.11in; width: 100%; max-height: 7.7in;" src="<?= $base64 ?>" alt="Background Image">
                    <div style="background:#000; position: absolute; bottom: 30.5%; left: 0; color: #fff; line-height: 30px; width: 100%; padding: 16px; box-sizing: border-box;">
                ...
                ?>
                        <div>
                            <h3 class="page_heading" class="page_heading" style="margin-bottom: 15px; background: #f1f4f6; color: #ff0000; padding: 16px; margin-top: 15px; font-size: 18px; border-radius: 6px;">
                            ...
                            ?>
                                <div class="tour_day" style="padding: 0 16px; margin: 50px 0;">
                                    <fieldset style="border: 2px solid #ff0000; border-radius: 6px; position: relative;">
                                        <legend style="position: absolute; top: -18px; background: #fff; padding: 0 12px;"><span style="font-size: 24px;">Day</span>
                                            <span style="font-size: 24px; font-weight: bold; color: #ff0000;"><?= $tourData[$i]['tour_day'] ?></span>
                                        </legend>
                                        <h4 style="font-size: 16px; margin-top: 12px; margin-bottom: 16px; float: left; width: 70%;">
                                            <?= $tourData[$i]['tour_name']; ?> </h4>
                                        <p style="font-size: 14px; font-weight: 500; float: right; color: #ff0000; line-height: 22px; margin: 0; width: 30%; text-align: right;">
                                            <img style="margin-right: 4px; display: inline-block; margin-top:5px;" src="<?= $calender_base64 ?>" alt="calander Icon"><span><?= $tourData[$i]['tour_date']; ?></span>
                                        </p>
                                        ...
                                        ?>
                                            <div style="margin-top: 14px; ">
                                                <p class="attractions" style="display: inline-block; color: #ff0000; margin: 10px 0 0px; font-size: 16px; font-weight: bold;">
                                                    Attractions :</p>
                                                <?php
                                                foreach ($htd as $key => $t) {
                                                    $hot_dest = trim($t);
                                                ?>
                                                    <span style="font-size: 14px; font-weight: 500;  margin-left: 8px; "><?= ucfirst($hot_dest) ?>
                                                    </span>
                                                <?php
                                                } ?>
                                            </div>
                ...
                ?>
                    ...
                    <div class="page" style="padding: 0 16px; margin: 40px 0;">
                        <fieldset style="border: 2px solid #ff0000; border-radius: 6px;">
                            <legend>
                                <h3 style="color: #ff0000; margin: 0; ">Hotel Details <img style="width: 20px; height: 20px;" src="<?= $hotel_base64 ?>">
                                </h3>
                            </legend>
                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($rate_meta)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; border: 1px solid #c6c1c1; text-align: left;" class='<?= $dicount ?>'>
                                                        <?= $standard_rates ?></td>
                                                    <td style="padding: 5px; border: 1px solid #c6c1c1; text-align: left;" class='<?= $dicount ?>'>
                                                        <?= $deluxe_rates ?></td>
                                                    <td style="padding: 5px; border: 1px solid #c6c1c1; text-align: left;" class='<?= $dicount ?>'>
                                            ...
                                            if (!empty($discountPriceData)) {
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <!--   Discount Price</td>-->
                                                        <td style="padding: 5px; border: 1px solid #c6c1c1; text-align: left;" class='<?= $strike_class ?>'><?= $s_price ?></td>
                                                        <td style="padding: 5px; border: 1px solid #c6c1c1; text-align: left;" class='<?= $strike_class ?>'><?= $d_price ?></td>
                                                        <td style="padding: 5px; border: 1px solid #c6c1c1; text-align: left;" class='<?= $strike_class ?>'><?= $sd_price ?></td>
                                                        <td style="padding: 5px; border: 1px solid #c6c1c1; text-align: left;" class='<?= $strike_class ?>'><?= $l_price ?></td>
                                                    </tr>
                                            <?php
                                                    // }
                                                }
				...
				echo "</pre>"; */
                    ...
                    <div class="page" style="padding: 0 16px; margin: 40px 0;">
                        <fieldset style="border: 2px solid #ff0000; border-radius: 6px;">
                            <legend>
                                <h3 style="color: #ff0000; margin: 0; "> Hotel Rates <img style="width: 20px; height: 20px;" src="<?= $hotel_base64 ?>">
                                </h3>
                            </legend>
                ...
                ?>
                    <div class="flight_details" style="padding: 0 16px; margin: 40px 0;">
                        <fieldset style="border: 2px solid #ff0000; border-radius: 6px;">
                            <legend>
                                <h3 style="color: #ff0000; margin: 0; ">Flights Details <img style="width: 20px; height: 20px;" src="<?= $airplane_base64 ?>"></h3>
                            </legend>

                            <div style="padding: 0 16px; margin: 20px 0;">
                                <table style="border-collapse: collapse; width: 100%; font-size: 15px; box-sizing: border-box;">
                                    <tr>
                                        <th style="padding:3px 20px 7px 20px; font-weight:500; border: 1px solid #c6c1c1; text-align: left;">
                                            Trip Type</th>
                ...
                ?>
                    ...
                    <div class="train_details" style="padding: 0 16px; margin: 40px 0;">
                        <fieldset style="border: 2px solid #ff0000; border-radius: 6px;">
                            <legend>
                                <h3 style="color: #ff0000; margin: 0; ">Train Details <img style="width: 20px; height: 20px;" src="<?= $train_base64 ?>"></h3>
                            </legend>
                            <div style="padding: 0 16px; margin: 20px 0;">
                                <table style="border-collapse: collapse; width: 100%; font-size: 15px; box-sizing: border-box;">
                                    <tr>
                        ...
                        <fieldset style="border: 2px solid #ff0000; border-radius: 6px;">
                            ...
                            <div style="padding: 0 16px; margin: 20px 0;">
                                <table style="border-collapse: collapse; width: 100%; font-size: 15px; line-height: 30px;">
                                    ...
                                    ?>
                                        <tr>
                                            <th style="padding: 5px; font-weight: 500; border: 1px solid #c6c1c1; text-align: left;">
                    ...
                    <fieldset style="border: 2px solid #ff0000; border-radius: 6px;">
                        ...
                        ?>
                            <div class="signature" style="margin-top: 30px; line-height: 26px; padding: 0 16px;">
                                ...
                                <p style="font-size: 16px; margin: 0;"><strong style="font-weight: 500;"><?= $agent->first_name . " " . $agent->last_name ?></strong>
                                </p>

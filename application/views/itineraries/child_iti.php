		...
		<div class="page-content">
			<div class="portlet box blue">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-users"></i>All Child Itineraries of ( Itinerary ID : <strong class=""><?php echo $currentIti; ?></strong> )
						 Package Type: <strong class=""> <?php echo check_iti_type( $currentIti ); ?></strong>
					</div>

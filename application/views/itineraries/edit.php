                        ...
                        <div class="form-horizontal over" id="itiForm_form">
                            ...
                            if (!empty($get_customer_info)) {  ?>
                                <section class="well bg_white overflow_visible section_customer_details">
                                    ...
                                    <div class="col-md-2 border_right_none">
                                        <strong><?php if (isset($cust->travel_date)) {
                                    ...
                                    <div class="col-md-2">
                                        <strong>Adults: <?php if (isset($cust->adults)) {
                                                            echo $cust->adults;
                                                        } ?></strong>
                                        <strong><?php if (isset($cust->child)) {
                                                    echo "Child: " . $cust->child . "( " . $cust->child_age . " )";
                                                } ?></strong>
                                    </div>
                                </section>
                            <?php } ?>
                                        ...
                                        <div class="tab-pane active" id="tab1">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" name="package_name" placeholder="Enter Package Name." value="<?php if (isset($iti->package_name)) {
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" value="<?php if (isset($iti->package_routing)) {
                                                                                    ...
                                                                                    } ?>" class="form-control" name="package_routing" placeholder="Enter Package Routing." />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-2">
                                                        <input type="text" required class="form-control" name="adults" value="<?php if (isset($iti->adults)) {
                                                                                                                                    echo $iti->adults;
                                                                                                                                } ?>" placeholder="Total no. of  adults eg: 2" />
                                                    </div>
                                                    <div class="col-md-2">
                                                        <input type="text" class="form-control" name="child" value="<?php if (isset($iti->child)) {
                                                                                                                        echo $iti->child;
                                                                                                                    } ?>" placeholder="Total child" />
                                                    </div>
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control" name="child_age" value="<?php if (isset($iti->child_age)) {
                                                                                                                            echo $iti->child_age;
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select required name="cab_category" class="form-control">
                                                            ...
                                                            if ($cars) {
                                                                foreach ($cars as $car) { ?>
                                                                    <option <?php if ($iti->cab_category == $car->id) { ?> selected="selected" <?php } ?> value="<?php echo $car->id ?>"><?php echo $car->car_name; ?>
                                                                    </option>;
                                                            <?php }
                                                            }
                                                            ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" id="package_duration" name="package_duration" placeholder="Enter Package Duration eg. 3 Nights and 4 days." value="<?php if (isset($iti->duration)) {
                                                                                                                                                                                                                        echo $iti->duration;
                                                                                                                                                                                                                    } ?>" />
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input required readonly="readonly" class="input-group form-control quatation_date" id="quatation_date" size="16" type="text" value="<?php if (isset($iti->quatation_date) && !empty($iti->quatation_date)) {
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <label class='mt-checkbox'>
                                                            <input type='checkbox' <?php if (isset($iti->is_flight) && $iti->is_flight  == 1) {
                                                                                        echo "checked";
                                                                                    } ?> name="is_flight" id='flight_ck' class='input-group form-control' value="1"><span></span>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-md-8">
                                                        <label class='mt-checkbox'>
                                                            <input type='checkbox' <?php if (isset($iti->is_train) && $iti->is_train  == 1) {
                                                                                        echo "checked";
                                                                                    } ?> name="is_train" id='train_ck' class='input-group form-control' value="1"><span></span>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <section class="overflow_visible bg_white position_relative margin-top-30 margin-bottom-40 row well details-package padding-0" id="flight_section" <?php if (isset($iti->is_flight) && $iti->is_flight  == 1) {
                                                    ...
                                                    <div class="btn-group flight_train_btns margin-bottom-40" data-toggle="buttons">
                                                        <label class="btn btn-default  custom_active <?php if (isset($flight->trip_type) && $flight->trip_type  == "oneway" || empty($flight)) {
                                                            ...
                                                            <input <?php if (isset($flight->trip_type) && $flight->trip_type  == "oneway" || empty($flight)) {
                                                                        echo "checked";
                                                                    } ?> type="radio" name="trip_r" class="trip_r" value="oneway" required />One Way</label>
                                                        <label class="btn btn-default  custom_active <?php if (isset($flight->trip_type) && $flight->trip_type  == "round") {
                                                                                                            echo "active";
                                                                                                                            ...
                                                                                                                            echo "checked";
                                                                                                                        } ?> required type="radio" name="trip_r" class="trip_r" value="round" />Round Trip</label>
                                                    </div>
                                                </div>
                                                <p></p>
                                                <div class="clearfix"></div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input required class="input-group form-control" size="16" type="text" value="<?php if (isset($flight->flight_name)) {
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input required class="input-group form-control" size="16" type="text" value="<?php if (isset($flight->total_passengers)) {
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input required class="input-group form-control" placeholder="Mumbai,Shimla etc" size="16" type="text" value="<?php if (isset($flight->dep_city)) {
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input required class="input-group form-control" placeholder="Mumbai,Shimla etc" size="16" type="text" value="<?php if (isset($flight->arr_city)) {
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input required readonly class="input-group form-control flight_dateTime" size="16" type="text" value="<?php if (isset($flight->dep_date)) {
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input required readonly class="input-group form-control flight_dateTime" size="16" type="text" value="<?php if (isset($flight->arr_time)) {
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input required class="input-group form-control" size="16" placeholder="10000 etc." type="number" value="<?php if (isset($flight->flight_price)) {
                                                                                                                                                                            echo $flight->flight_price;
                                                                                                                                                                        } ?>" name="flight_cost" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 return_flight_name" style="<?php if (isset($flight->return_flight_name)) { ?> display:block <?php } ?>">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-4"> Return Flight Name
                                                            <span class="required"> * </span>
                                                        </label>
                                                        <div class="col-md-8">
                                                            <input class="input-group form-control" type="text"  id="return_f_name"
                                                            value="<?php if (isset($flight->return_flight_name)) {  echo $flight->return_flight_name;
                                                              } ?>" name="return_flight_name" placeholder="Jet Airways,SpiceJet etc" />
                                                        </div>
                                                    </div>
                                                </div>

                                                <div class="col-md-6 f_h_return_date" style="<?php if (isset($flight->return_date)) { ?> display:block <?php } ?>">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            ...
                                                            <input class="input-group form-control flight_dateTime" size="16" type="text" value="<?php if (isset($flight->return_date)) {
                                                                                                                                                        echo $flight->return_date;
                                                                                                                                                    } ?>" name="return_date" id="return_date" />
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6 f_h_return_arr_date" style="<?php if (isset($flight->return_date)) { ?> display:block <?php } ?>">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <textarea required class="input-group form-control" name="flight_other_details"><?php if (isset($flight->flight_other_details)) {
                                            ...
                                            <section class="padding-0 bg_white well row details-package position_relative margin-top-30 overflow_visible" id="train_section" <?php if (isset($iti->is_train) && $iti->is_train  == 1) {
                                                                                                                                                                                    echo "style='display: block;'";
                                                                                                                                                                                } ?>>
                                                <div class="form_ft_caption">
                                                    <h3>Train Details</h3>
                                                    ...
                                                    <div class="btn-group flight_train_btns margin-bottom-40" data-toggle="buttons">
                                                        <label class="btn btn-default custom_active <?php if (isset($train->t_trip_type) && $train->t_trip_type  == "oneway" || empty($train)) {
                                                            ...
                                                            <input <?php if (isset($train->t_trip_type) && $train->t_trip_type  == "oneway" || empty($train)) {
                                                                        echo "checked";
                                                                    } ?> type="radio" name="t_trip_r" class="t_trip_r" value="oneway" required />One Way</label>
                                                        <label class="btn btn-default  custom_active <?php if (isset($train->t_trip_type) && $train->t_trip_type  == "round") {
                                                                                                            echo "active";
                                                                                                                            ...
                                                                                                                            echo "checked";
                                                                                                                        } ?> required type="radio" name="t_trip_r" class="t_trip_r" value="round" />Round Trip</label>
                                                    </div>
                                                </div>
                                                <p></p>
                                                <div class="clearfix"></div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input required class="input-group form-control" size="16" type="text" value="<?php if (isset($train->train_name)) {
                                                                                                                                                echo $train->train_name;
                                                                                                                                            } ?>" name="train_name" placeholder="Adi Duronto Express, Arunachal Express etc" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input required class="input-group form-control" size="16" type="text" value="<?php if (isset($train->train_number)) {
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input required class="input-group form-control" size="16" type="text" value="<?php if (isset($train->t_passengers)) {
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input required class="input-group form-control" placeholder="Mumbai,Shimla etc" size="16" type="text" value="<?php if (isset($train->t_dep_city)) {
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input required class="input-group form-control" placeholder="Mumbai,Shimla etc" size="16" type="text" value="<?php if (isset($train->t_arr_city)) {
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input required readonly class="input-group form-control train_dateTime" size="16" type="text" value="<?php if (isset($train->t_dep_date)) {
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input required readonly class="input-group form-control train_dateTime" size="16" type="text" value="<?php if (isset($train->t_arr_time)) {
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input required class="input-group form-control" size="16" placeholder="10000 etc." type="number" value="<?php if (isset($train->t_cost)) {
                                                                                                                                                                            echo $train->t_cost;
                                                                                                                                                                        } ?>" name="t_cost" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 return return_train_name" style="<?php if (isset($train->return_train_name)) { ?> display:block <?php } ?>">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-4">Return Train Name
                                                            <span class="required"> * </span>
                                                        </label>
                                                        <div class="col-md-8">
                                                            <input class="input-group form-control" size="16" type="text" id="return_t_name" value="<?php if (isset($train->return_train_name)) {
                                                                                                                                                echo $train->return_train_name;
                                                                                                                                            } ?>" name="return_train_name" placeholder="Adi Duronto Express, Arunachal Express etc" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 t_return_date" style="<?php if (isset($flight->return_date)) { ?> display:block <?php } ?>">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-4">Return Date & Time
                                                            <span class="required"> * </span>
                                                        </label>
                                                        <div class="col-md-8">
                                                            <input <?php if (isset($train->t_return_date) && empty($train->t_return_date)) {
                                                                        echo "disabled";
                                                                    } ?> class="input-group form-control train_dateTime" size="16" type="text" value="<?php if (isset($train->t_return_date)) {
                                                ...
                                                <div class="col-md-6 t_return_arr_date" style="<?php if (isset($flight->return_date)) { ?> display:block <?php } ?>">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-4">Return Arrival Date & Time
                                                            <span class="required"> * </span>
                                                        </label>
                                                        <div class="col-md-8">
                                                            <input <?php if (isset($train->t_return_arr_date) && empty($train->t_return_arr_date)) {
                                                                        echo "disabled";
                                                                    } ?> class="input-group form-control train_dateTime" size="16" type="text" value="<?php if (isset($train->t_return_arr_date)) {
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <textarea required class="input-group form-control" name="train_other_details" />
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="mt-repeater-input  ">
                                                                            ...
                                                                            <select required name="meal_plan" class="form-control">
                                                                                ...
                                                                                <option value="Breakfast Only" <?php if (isset($tourData[$i]['meal_plan']) && $tourData[$i]['meal_plan'] == "Breakfast Only") { ?> selected="selected" <?php } ?>>Breakfast
                                                                                    Only</option>
                                                                                <option <?php if (isset($tourData[$i]['meal_plan']) && $tourData[$i]['meal_plan'] == "Breakfast & Dinner") { ?> selected="selected" <?php } ?> value="Breakfast & Dinner"> Breakfast &
                                                                                    Dinner</option>
                                                                                <option <?php if (isset($tourData[$i]['meal_plan']) && $tourData[$i]['meal_plan'] == "Breakfast, Lunch & Dinner") { ?> selected="selected" <?php } ?> value="Breakfast, Lunch & Dinner">Breakfast,
                                                                                    Lunch & Dinner</option>
                                                                                ...
                                                                                <option <?php if (isset($tourData[$i]['meal_plan']) && $tourData[$i]['meal_plan'] == "No") { ?> selected="selected" <?php } ?> value="No">No
                                                                                    Meal Plan</option>
                                                                            </select>
                                                                        </div>
                                                                        <div class="mt-repeater-input  ">
                                                                ...
                                                                <div data-repeater-item class="mt-repeater-spinc-item form-group">
                                                                    <div class="mt-repeater-spinc-cell">
                                                                        <div class="mt-repeater-spinc-input col-md-9">
                                                                            <input type="text" name="tour_special_inc" class="form-control" value="<?php if (isset($sp_inc[$i]["tour_special_inc"])) {
                                                            ...
                                                            if (!empty($benefits_inc)) {
                                                                ...
                                                                for ($i = 0; $i < $count_benefit_inc; $i++) {        ?>
                                                                    <div data-repeater-item class="mt-repeater-spinc-item form-group">
                                                                        <div class="mt-repeater-spinc-cell">
                                                                            <div class="mt-repeater-spinc-input col-md-9">
                                                                                <input required type="text" name="benefit_inc" class="form-control" value="<?php if (isset($benefits_inc[$i]["benefit_inc"])) {
                                                ...
                                                ?>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <!--div class='form-group col-md-2' >
																...
																<input type="checkbox" value="<?php //echo $inc_gst; 

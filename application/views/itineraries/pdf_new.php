        ...
        <div class="page_content">
            <div class="banner_area">
                <div class="page_header">
                    <div>
                    <img class="logo_img" src="<?= $image_file ?>" alt="Track Itinerary Software">
                    </div>
            ...
            <div class="page ">
                <div class="itinerary_section" style="padding: 16px;">
                    ...
                    <?php
                        ...
                        ?>
                    <div class="day_wise_itinerary" style="margin-bottom: 22px;margin-top: 30px;padding: 0 16px;background: #eceff6;border-radius: 12px;padding-top: 18px;">
                        <div class="day">
                            <p> <strong style="background:#5e72e4; padding:4px 19px; border-radius: 12px; color: #fff;">Day  <?= $tourData[$i]['tour_day'] ?></strong> <span style="font-size: 16px; font-weight: bold; margin-left: 16px;"><?= $tourData[$i]['tour_date']; ?></span></p>
                        </div>
                        <div class="tour_tittle">
                            ...
                            <span style="font-size:16px; font-weight: bold;"><?= $tourData[$i]['meal_plan'];?> <i class="fa fa-cutlery"></i></span>
                        </div>
                        ...
                        <div style="margin-top: 14px;">
                            <p class="attractions" style="display: inline-block; color: #5e88ea; margin: 0 0 6px; font-size: 16px; font-weight: bold;">
                                Attractions :</p>
                            <span style="font-size: 14px; font-weight: 500;  margin-left: 8px;">Naggar
                                Castle,</span>
                            <span style="font-size: 14px; font-weight: 500;  margin-left: 8px;">Manikaran,</span>
                            <span style="font-size: 14px; font-weight: 500;  margin-left: 8px;">Kasol
                                Valley</span>
                        </div>
                    </div>
                    <?php
            ...
            <table>
                ...
                <tbody>
                    ...
                    if( !empty( $rate_meta ) ){
                        ...
                        $per_person_ratemeta 	= !empty($iti->per_person_ratemeta) ? unserialize($iti->per_person_ratemeta) : '';
                ...
                <?php
                    ...
                    ?>
                    <tr>
                        <td style="font-size: 12px;">Discount Price</td>
...
<?php
	...
	if($user_info){
		$agent = $user_info[0];
        ?>
            <div class="signature page" style="margin-top: 260px; line-height: 25px;">

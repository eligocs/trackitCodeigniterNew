        ...
        <div class="page-content">
            ...
            <?php if( !empty($itinerary ) ){ 
				...
				if( $iti->is_amendment == 2 ){ 
					...
					$amendment_note = !empty( $amendment_cmt ) ? "<p class='alert alert-danger margin-bottom-25'> <strong><i class='fas fa-hand-point-right'></i> REVISED ITINERARY</strong> Amendment: {$amendment_cmt[0]->review_comment}</p>" : "";
				}  
            ...
            <div class="row2">
                ...
                <div class="portlet box blue">
                    <div class="portlet-title">
                        <div class="custom_title"><i class="far fa-calendar-alt"></i> Package Overview</div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="7">No Cab booking create against this itinerary.
                                        <a href="<?php echo $add_cab_booking_link; ?>" class="" title="Book cab">Click
                                            here
                                            to book</a>
                                    </td>
                                </tr>
                        ...
                        <button type="submit" <?php echo empty($continue_cab) ? "disabled" : ""; ?>
                            ...
                            data-booking_type="cab_booking_status"
                            class="btn btn_blue_outline uppercase confirm_booking_btn"
                            title="All Volvo/Train/Flight Booking Done">Confirm All Cab Booking Done</button>
                        <div class='alert alert-danger margin-top-20'><strong>Note: </strong>If you confirm Cab booking
                            you
                            can't able to
                            create new booking against this itinerary. You can't confirm booking if booking is on
                            processing
                            stage.</div>
                        </p>
                        <?php } ?>
                ...
                <div class="portlet-body ">
                    <div class="table-responsive">
                        ...
                        <button <?php echo empty($continue_vtf) ? "disabled" : ""; ?> type="submit"
                            ...
                            data-booking_type="vtf_booking_status"
                            class="btn btn_blue_outline uppercase confirm_booking_btn"
                ...
                <div class="portlet-body ">
                    <div class="table-responsive">
                        ...
                        <button <?php echo empty($continue_hotel) ? "disabled" : ""; ?> type="submit"
                            ...
                            data-booking_type="hotel_booking_status"
                            class="btn btn_blue_outline uppercase confirm_booking_btn"
                            title="All Hotel booking Done">Confirm All Hotel Booking Done</button>
                        <p class="margin-top-20" style="font-size:12px; color: red;"><strong>Note: </strong>If you
            ...
            <div class="mt-element-step portlet box blue">
                <div class="portlet-body">
                    <div class="row step-line">
                        ...
                        <div class="col-md-3 mt-step-col <?php echo $vtf_class; ?>"
                            title="Volvo/Train/Flight Booking Status. Green = done, Red = Pending" data-toggle="tooltip">
                        ...
                        <div class="col-md-3 mt-step-col <?php echo $pay_class; ?>"
                            title="Cab Booking Status. (Green >= 50 %, Red < 50%) Amount received" data-toggle="tooltip">
                            <div class="mt-step-number bg-white">
                                <i class="fa fa-inr"></i>
                            </div>
            ...
            <div class="custom_card">
                <div class="inquery_section margin-bottom-25">
                    ...
                    <p class="text-center d_inline_block ">
                        <?php $old_count = 1;

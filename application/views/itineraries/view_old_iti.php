			...
			<?php if( !empty($itinerary[0] ) ){ 			
				...
				<div class="portlet box blue">
					<div class="portlet-title">
						...
						{ Package Type: <strong class="text-white"> <?php echo check_iti_type( $iti->iti_id ); ?></strong> }
						</div>
				...
				<div class="portlet box blue">
    				 <div class="portlet-body ">
    					 <div class="row">
        					 <div class="col-md-6">
        					    <div class="alert alert-danger strong margin-bottom-20"> <strong><i class="fas fa-hand-point-right"></i></strong> OLD ITINERARY</div>
        						<table class="table">	
        							<tr>
				...
				<div class="row2">
					...
					<div class="portlet-title">
						<div class="custom_title"><i class="fas fa-book"></i> Package Overview</div>
					</div>	
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="custom_title"> <i class="far fa-file-alt"></i> Day Wise Itinerary</div>
						</div>
					...
					<div class="portlet box blue margin-top-50">
						<div class="portlet-title">
							<div class="custom_title"><i class="fal fa-info-square"></i>Inclusion & Exclusion</div>
						</div>	
					...
					if( !empty($benefits_m) ){
						echo '<div class="portlet box blue"><div class="portlet-title"><h3 class="custom_title">Benefits of Booking With Us</h3></div>';
						echo "<div class='portlet-body'><ul class='inclusion'>";
						if( $count_bn_inc > 0 ){
					...
					<div class="portlet box blue margin-top-50">
					<div class="portlet-title"><h3 class="custom_title">Hotel Details</h3></div>

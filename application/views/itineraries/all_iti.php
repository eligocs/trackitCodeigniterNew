                                        ...
                                        <div class="d-flex justify-content-between px-1 w-100">
                                            <div class="requirment">
                                                ...
                                                <div title="Tour Type" class="badge bg-danger mb-1 me-2">
                                                    <strong class="white">Accommodation</strong> 
                                                </div>
                                            ...
                                            <div class="flex-grow-1 ms-2">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="tooltip_right">
                                                        ...
                                                        <span class="tooltip_right_text">sandeepthorot4548@gmail.com</span>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="align-bottom align-content-between d-flex flex-wrap h-100">
                                        <div class="d-flex justify-content-between px-1 w-100">
                                            <div class="requirment">
                                                ...
                                                <span>/</span>
                                                <p title="Lead Id" class="fs-7 fw-bold mb-2 mt-0 d-inline-block">#545</p>
                                                <div title="Tour Type" class="badge bg-success mb-1 me-2">
                                                    <strong class="white">Holidays</strong> 
                                                </div>
                                                <div  class="fs-8 me-2 text-success">
                                                    <strong class="" title="Iti Status
                                                        ">Working...</strong> 
                                    ...
                                    <div class="align-bottom align-content-between d-flex flex-wrap h-100">
                                        <div class="px-2">
                                            <div class="mb-2">
                                                ...
                                                <strong class="">Gourp Tour</strong>
                                                </span>
                                            </div>
                                            <div class="package-title">
                                                <span class="text-secondary fs-7">Charming Shimla &amp; Exotic Manali Holidays Tour</span>
                                ...
                                <td>
                                    <div class="align-bottom align-content-between d-flex flex-wrap h-100">
                                        <div class="px-2">
                                            <div class="mb-2">
                                                <strong class="d-block fs-7">Himahal Pradesh </strong> 
                                                <span class="badge bg-yellow-gold mt-2">
                                                <strong class="">Other</strong>
                                                </span>
                                            </div>
                                            <div class="package-title">
                                                <span class="text-secondary fs-7">Charming Shimla &amp; Exotic Manali Holidays Tour</span>
                                        ...
                                        <div class="px-2">
                                            <div class="mb-2">
                                                ...
                                                <span class="badge bg-success mt-2">
                                                    <strong class="">Honeymoon Tour</strong>
                                                </span>
                                            </div>
                                            <div class="package-title">
                                                <span class="text-secondary fs-7">Charming Shimla &amp; Exotic Manali Holidays Tour</span>

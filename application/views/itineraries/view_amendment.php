		...
		<div class="page-content">
			...
			<div class="portlet box blue">
				<div class="portlet-title">
					...
					{ Package Type: <strong> <?php echo check_iti_type( $iti->iti_id ); ?></strong> }
					</div>
					...
					<div class="row">
						<div class="col-md-12 my-2">
							<div class="form-group">
								<label class="control-label" for="">Please Enter Comment For Admin/Manager</label>
						...
						<div class="col-md-12 my-2">
							...
							<button type="submit" id="reqDis_btn" class="btn btn-success">

        ...
        <div class="page-content">
            ...
            <div class="portlet-body">
                <div class='agent_info_section bg-white p-3 rounded-4 shadow-sm' style="display:none;">
                    ...
                    <h4 class='text-center'><strong class="red">Agent Name: </strong><span id='ainfo_name'></span>
                        <strong class='red'>Month: </strong><span id='ainfo_month'></span></h4>
...
jQuery(document).ready(function($) {
    ...
    $(document).on("click", ".export_btn", function(e) {
        ...
        var export_url = "<?php echo base_url('incentive/export_incentive_all_agents?month='); ?>" +
            datefrom;
        //redirect to export
            ...
            success: function(res) {
                ...
                if (res.status == true) {
                    ...
                    if (res.succ == 1) {
                        ...
                        $(".cong_theme_2").html(
                            '<div class="fix_cong_section"></div><div class="congo_text"><div class="canvas_text showMe"><p class="text-congrat">Congratulations</p></div></div>'
                            );
            ...
            if (willDelete) {
                $.ajax({
                    url: "<?php echo base_url(); ?>" +
                        "incentive/ajax_below_base_price_updateStatus",
                    type: "POST",
                    data: {
                        "id": id,
                        "is_below_base_price": chkVal
                    },
                    dataType: 'json',
                    success: function(res) {
                        _genrate_incentive();

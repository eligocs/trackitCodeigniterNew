...
<div class="page-container customer_content">
	...
	<div class="page-content-wrapper">
		...
		<div class="page-content">
			...
			<?php $attributes = array('id' => 'editCustomer', 'class' => 'mb-0'); ?>
			<?php  echo form_open('customers/editcustomer', $attributes); ?>
			<div class="portlet box blue">
				<div class="portlet-title">
					<div class="caption"><i class="fa fa-users"></i>Customer Name: <strong>
						<?php  echo    $customer->customer_name; ?></strong>  Customer Type: <strong class=''><?php  echo get_customer_type_name($customer->customer_type); ?></strong>
			...
			<div class="portlet-body">
				<div class="bg-white p-3 rounded-4 shadow-sm">
					<div>
						<h4 class="mb-3 fs-6">Quotation Type: <?php echo ucfirst ( $quo_type ); ?> 
					...
					<div class="row">
						...
						<?php if( !empty( $customer->adults ) && !empty($customer->hotel_category) ){ ?>
							...
							<div class="col-lg-4 col-md-6 my-2 <?php echo $hide_accommodation; ?>">
								<div class="form-group">

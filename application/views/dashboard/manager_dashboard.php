                            ...
                            <div class="col-md-12">
                                <div class="panel">
                                    ...
                                    <div class="panel-body padding-0">
                                        <div class="dashboard-scroll">
                                            <div class="tab-content">
                                                <div class="tab-pane  in active" id="rate_request">
                                                    <table class="table table-hover d-table table-fixed">
                                                        <tr>
                                                            <th>Sr.</th>
                                                            <th>Name</th>
                                                ...
                                                <div class="tab-pane " id="approved_rates">
                                                    <table class="table table-bordered table-striped d-table table-fixed">
                                                        <thead>
                                                            <tr>
                                                                <th>Sr.</th>
                            ...
                            <div class="col-md-12">
                                <div class="panel">
                                    ...
                                    <div class="panel-body padding-0">
                                        <div class="dashboard-scroll">
                                            <div class="tab-content">
                                                <div class="tab-pane  in active" id="pending_rates">
                                                    <table class="table table-hover d-table table-fixed">
                                                        <tr>
                                                            <th>Sr.</th>
                                                            <th>Name</th>
                            ...
                            <div class="col-md-12">
                                <div class="panel">
                                    ...
                                    <div class="panel-body padding-0">
                                        <div class="dashboard-scroll">
                                            <div class="tab-content">
                                                <div class="tab-pane  in active" id="tab40k">
                                                    <table class="table table-hover d-table table-fixed">
                                                        <tr>
                                                            <th>Sr.</th>
                                                            <th>Name</th>
                                ...
                                <!-- <div class="tab-content">
                                    ...
                                    <div class="col-md-6">
                                        <div class="titile_section row">
                                            <h3 class="col-lg-12">Itineraries Graph</h3>
                                            <div class="form-group col-lg-6">
                                                <label class="control-label" for="sel1">Select Agent:</label>
                                                <select class="form-control" id="agent_graph">
                                                    <option value="">All Agents</option>
                                                    <?php
                                                    if ($get_agents) {
                                            ...
                                            <div class="form-group col-lg-6 pull-right">
                                                <label class="control-label" for="sel1">Select Date:</label>

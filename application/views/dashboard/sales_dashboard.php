...
<div class="page-container">
    <div class="page-content-wrapper sales_team_dashboard">
        ...
        <div class="page-content p-4">
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="custom_title"><i class="fa fa-handshake-o" aria-hidden="true"></i> ON HOLD ITINERARIES / CHECKOUT
                    </div>
                </div>
                                        ...
                                        <div class="tab-pane  in active" id="tab1primary">
                                            <table class="table table-hover d-table table-fixed">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn_eye" target="_blank"
                                                            href="<?php echo $view_link; ?>"><i class="fa-solid fa-eye"></i></a></td>
                                                </tr>
                                                <?php } 
                                                }else{ ?>
                                                <tr>
                                            ...
                                            <div class="tab-pane  in active" id="tab2">
                                                ...
                                                foreach( $amendmentPendingRates as $aRates ){ 	?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a class="btn btn_eye" target="_blank"
                                                                href="<?php echo site_url("itineraries/view_amendment/{$aRates->id}"); ?>"><i class="fa-solid fa-eye"></i></a>
                                                        </td>
                                                    </tr>
                                                    <?php } 
                                            }else{ ?>
                                                ...
                                                <table class="table table-bordered table-striped d-table table-fixed">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a class="btn btn_eye" target="_blank"
                                                                    href="<?php echo site_url("itineraries/view_amendment/{$apRates->id}"); ?>"><i class="fa-solid fa-eye"></i></a>
                                                            </td>
                                                        </tr>
                                                        <?php } 
                                                    }else{ ?>
                                            ...
                                            <div class="tab-pane  in active" id="tab4">
                                                <table class="table table-bordered table-striped d-table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a class="btn btn_eye"
                                                                href="<?php echo site_url("customers/view/{$t_leads->customer_id}/{$t_leads->temp_key}"); ?>"><i class="fa-solid fa-eye"></i></a>
                                                        </td>
                                                    </tr>
                                                    <?php } 
                                                }else{ ?>
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="custom_title"><i class="fa fa-handshake-o" aria-hidden="true"></i> Rates Section</div>
                </div>
                <div class="portlet-body">
                    <div class="row dashboard-tables-all-info">
                        <div class="col-md-12">
            ...
            <div class="total-leads-for-month">
                <div class="month_section">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="custom_title"><i class="fa fa-file-text-o" aria-hidden="true"></i> Month's Status
                            </div>
                        </div>
                        <div class="portlet-body row">
                            <div class="col-md-4 col-lg-3">
            ...
            <!-- Charts secton -->
            <div class="bg-white mt-4 p-3 rounded-4 shadow-sm">
                <div class="row">
                    <div class="col-md-6">

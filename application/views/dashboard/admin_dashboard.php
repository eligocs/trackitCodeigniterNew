            ...
            <div class="page-content p-4">
                ...
                <div class="portlet box blue">
                    ...
                    <div class="todayssection row">
                        ...
                        <!-- <div class="clearfix"></div> -->
                        <div id="todays_full_stats" class="row">
                            <div class="col-lg-4 col-md-4">
                                <div class="callCountBlock">
                    ...
                    <div class="month_section">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                ...
                                <button type="button" data-target_id="month_full_stat" class="btn btn_blue_outline purple view_all_stat_btn float-end" style="margin-top: 3px;">

    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <div class="featured-img"
                ...
                <div class="package-title position-absolute bg-blue-ebonyclay-opacity package_name_set"> </div>
            ...
            <div class="" id="form_wizard_1">
                <div class="portlet-body form bg-white p-3 rounded-4 shadow-sm">
                    <form id="itiForm_form">
                                            ...
                                            <div class="row card_border_blue mt-4 row">
                                                ...
                                                <div class="col-md-4 my-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-11">
                                                            <input type="text" class="form-control package_name_get" name="package_name" placeholder="Enter Package Name." value="<?= !empty($itinerary[0]->package_name) ? $itinerary[0]->package_name : '' ;?>" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 my-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-11">
                                                            <input type="text" required class="form-control" id="package_duration" name="package_duration" placeholder="Enter Package Duration eg. 3 Nights and 4 days." value="<?= !empty($itinerary[0]->duration) ? $itinerary[0]->duration : '' ;?>" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 my-2">
                                                ...
                                                <div class="col-md-4 my-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-11">
                                                            <input type="text" required class="form-control" name="package_routing" placeholder="Enter Package Routing." value="<?= !empty($itinerary[0]->package_routing) ? $itinerary[0]->package_routing : '  ' ;?>" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 my-2">
                                                ...
                                                <div class="col-md-6 my-2">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-3 mb-3 mb-md-0">
                                                            <input type="text" required class="form-control" name="adults" value="<?= !empty($itinerary[0]->adults) ? $itinerary[0]->adults : '' ;?>" placeholder="Adults" />
                                                        </div>
                                                        <div class="col-md-3 mb-3 mb-md-0">
                                                            <input type="text" class="form-control" name="child" value="<?= !empty($itinerary[0]->child) ? $itinerary[0]->child : '' ;?>" placeholder="Children" />
                                                        </div>
                                                        <div class="col-md-5">
                                                            <input type="text" class="form-control" name="child_age" value="<?= !empty($itinerary[0]->child_age) ? $itinerary[0]->child_age : '' ;?>" placeholder="Child Age: eg. 12,15,18." />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 my-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-11">
                                                            <input type="number" class="form-control pakage_cost" name="pakage_starting_cost" value="<?= !empty($itinerary[0]->pakage_starting_cost) ? $itinerary[0]->pakage_starting_cost : '' ;?>" placeholder="Enter Package Starting Cost." required />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mt-repeater">
                                                <div data-repeater-list="tour_meta">
                                                    ...
                                                    <div data-repeater-item class="mt-repeater-item daywise_section">
                                                        <!--strong>Day: </strong><strong class="sta_d">
                                                            <?php //echo $i+1; ?></strong-->
                                                        <div class="row">
                        ...
                        ?>
                        <input id="unique_key" type="hidden" name="temp_key" value="<?= !empty($temp_key) ? $temp_key :  $unique_key; ?>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="tab-content">
                            ...
                            <li>
                                <div class="thumbnail">
                                    <img src="<?= site_url() . 'site/images/package_pdf/' . $libraryOfPdfImg->package_pdf_img; ?>"
                                        ...
                                        data-id="<?= site_url() . 'site/images/package_pdf/' . $libraryOfPdfImg->package_pdf_img; ?>">
                                    </div>
                            </li>
                            <?php
                                }
                    ...
                    <div id="searchImg" class="container tab-pane fade">
                        <h3>Search</h3>
